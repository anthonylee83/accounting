...
Route::get('/trial/unadjusted/{date?}', 'TrialBalanceController@unadjusted');
Route::get('/trial/adjusted/{date?}', 'TrialBalanceController@adjusted');
Route::get('/trial/closing/{date?}', 'TrialBalanceController@closing');
