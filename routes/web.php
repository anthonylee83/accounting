...
Route::get('/trial/unadjusted', 'TrialBalanceController@unadjusted');
Route::get('/trial/adjusted', 'TrialBalanceController@adjusted');
Route::get('/trial/closing', 'TrialBalanceController@closing');
